...
public class TableApiModel<T, L> implements Model<T, L> {
	...
	public TableApiModel(Helper helper, DataProcessor<T, L> processor) {
		this.helper = helper;
		this.processor = processor;
		this.tableModel = null;
	}

	public TableApiModel(TableMetaData meta, Helper helper, DataProcessor<T, L> processor) {
		this.helper = helper;
		this.processor = processor;
